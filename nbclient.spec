...
%prep
%setup -q -n nbclient-0.5.8
cd %{_builddir}/nbclient-0.5.8
...
cp %{_builddir}/nbclient-0.5.8/LICENSE %{buildroot}/usr/share/package-licenses/nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
