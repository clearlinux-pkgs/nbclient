...
Source0  : https://files.pythonhosted.org/packages/fc/be/c61d973ff6a53bfd961e81bfccf38d0bb7612546c247afeb27985430c593/nbclient-0.5.4.tar.gz
...
%prep
%setup -q -n nbclient-0.5.4
cd %{_builddir}/nbclient-0.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635757297
...
cp %{_builddir}/nbclient-0.5.4/LICENSE %{buildroot}/usr/share/package-licenses/nbclient/8a1fbf91e5334237f0176576f8ad1a679b8135a8
